    ...
    <div class="jumbotron m-0 w-100">
        <div class="row no-gutters content">
            <div class="col-lg-7 col-md-8">
                ...
                if ($a->user) {
                    ?>
                <button class="btn btn-orange btn-lg d-inline-block p-3" data-target="#field-choose" data-toggle="modal"
                    id="new-moment">
                        ...
                        <div class="collapse navbar-collapse" id="moment-footer-navbar">
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item dropup">
                                    <a role="button" class="nav-link dropdown-toggle red-text" id="moment-visibility"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i
                                            class="oi oi-eye"></i> <span id="moment-visibility-text">公开</span></a>
                                    <div class="dropdown-menu dropdown-primary" aria-labelledby="moment-visibility"
                                        id="moment-visibility-option">
                                        <a class="dropdown-item active" role="button" data-visibility="public">公开</a>
...
<div class="modal fade" id="field-choose" tabindex="-1" role="dialog" aria-labelledby="field-choose" aria-hidden="true">
    <div class="modal-dialog modal-notify modal-danger" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center">
                <button type="button" class="btn btn-danger" id="new-moment-confirm"><span class="oi oi-plus"></span>
                    现在发布</button>
        ...
        <div class="modal-content">
            ...
            <form method="get" action="<?php ($a->U)('Striverboard', 'Index', [
                ...
                <div class="modal-body">
                    ...
                    <div class="md-form">
                        <select id="show-mode-field" class="mt-5 mb-0 browser-default custom-select md-form" name="fid">
                ...
                <div class="modal-footer justify-content-center">
                    <button type="submit" class="btn btn-danger" id="show-mode-submit"><span class="oi oi-check"></span>
                        现在发布</button>
                </div>
            </form>
        </div>

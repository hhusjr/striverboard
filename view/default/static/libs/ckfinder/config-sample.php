...
$uid = isset($_SESSION['striverboard_ckfinder_user_id']) ? $_SESSION['striverboard_ckfinder_user_id'] : false;
...
$config['authentication'] = function () use ($uid) {
...
$dir = $uid ? sha1($uid) : 'unknown';
$config['privateDir'] = array(
    'backend' => 'default',
    'tags'   => '.ckfinder/' . $dir . '/tags',
    'logs'   => '.ckfinder/' . $dir . '/logs',
    'cache'  => '.ckfinder/' . $dir . '/cache',
    'thumbs' => '.ckfinder/' . $dir . '/cache/thumbs',
);
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => 'http://127.0.0.1/data/uploads/' . $dir,
    'root'         => '/Users/zeroisone/web/striverboard/data/uploads/' . $dir, // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
